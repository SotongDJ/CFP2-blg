...
final_root_path="https://xn--xp8h.xn--2os22eixx6na.xn--kpry57d/";
final_artist_str="百靈果 News";

document.getElementById("aboutA").href="https://github.com/SotongDJ/cfp2-blg";
document.getElementById("emailA").href="mailto:github@stdj.me?subject=BLG 回饋信件&body=內容類型：（問題？建議？）%0A細節：（越詳細越好）";
document.getElementById("infoA").href="https://github.com/SotongDJ/cfp2-blg/wiki";
